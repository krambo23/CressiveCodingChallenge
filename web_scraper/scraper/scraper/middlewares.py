...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def _scrapeops_fake_user_agents_enabled(self):
        if (self.scrapeops_api_key is None) or (self.scrapeops_api_key == "") or \
                (not self.scrapeops_fake_user_agents_active):
...
class ScrapeOpsFakeBrowserHeaderMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_fake_browser_headers_active = settings.get("SCRAPEOPS_FAKE_BROWSER_HEADERS_ENABLED")
        self.scrapeops_num_results = settings.get("SCRAPEOPS_NUM_RESULTS")
        self.headers_list = []
    ...
    def _scrapeops_fake_browser_headers_enabled(self):
        if (self.scrapeops_api_key is None) or (self.scrapeops_api_key == "") or \
                (not self.scrapeops_fake_browser_headers_active):
